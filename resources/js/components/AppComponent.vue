    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <chart-component title="Holdings" cardId="topHoldings" componentId="holdings" v-if="ETF && ETF.holdings.length" :data="ETF.holdings"
                                 chartType="horizontalBar"/>
                <chart-component title="Country Weights"  cardId="countryWeights" componentId="country-charts" v-if="ETF && ETF.country_weights.length"
                                 :data="ETF.country_weights"
                                 nameField="name"/>
                <error-component v-if="ETF && !ETF.country_weights.length" ></error-component>
                <chart-component title="Sector Weights" componentId="sector-charts" cardId="sectorWeights"  v-if="ETF && ETF.sector_weights.length"
